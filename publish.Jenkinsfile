...
def modifyBuildDescription() {
    def CHART_NAME = "eric-oss-app-mgr-test"
    def DOCKER_IMAGE_NAME = "eric-oss-app-mgr-test"
    def VERSION = readFile('.bob/var.version').trim()
    def CHART_DOWNLOAD_LINK = "https://arm.seli.gic.ericsson.se/artifactory/proj-eric-oss-drop-helm-local/oss-testware/${CHART_NAME}/${CHART_NAME}-${VERSION}.tgz"
